export default function DashboardPage() {
  return (
    <div className="px-4 py-6 sm:px-0">
      <div className="border-2 border-dashed border-secondary-200 bg-secondary-50 rounded-lg p-8">
        <div className="text-center">
          ...
          <p className="text-lg font-body text-neutral-600 mb-8">
            Find times that fit their schedule and yours. Integrates with your calendar.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-white p-6 rounded-lg shadow-md border border-secondary-200 hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-display font-semibold text-neutral-900 mb-2">Contacts</h3>
              <p className="font-body text-neutral-600 mb-4">Manage your professional network and meeting preferences</p>

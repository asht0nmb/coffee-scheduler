    ...
    <div className="px-4 py-6 sm:px-0">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-display font-semibold text-neutral-900">Smart Scheduling</h1>
          <p className="mt-2 text-sm font-body text-neutral-600">
            AI-powered scheduling that finds optimal meeting times across time zones.
          </p>
        </div>
      </div>
      ...
      <div className="mt-8 border-2 border-dashed border-secondary-200 bg-secondary-50 rounded-lg p-8">
        <div className="text-center">
          ...
          <h3 className="mt-2 text-lg font-display font-semibold text-neutral-900">Intelligent Batch Scheduling</h3>

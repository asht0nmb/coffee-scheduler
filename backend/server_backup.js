...
mongoose.models.SuggestedSlot || mongoose.model('SuggestedSlot', suggestedSlotSchema);
...
app.use('/api/calendar', ensureAuthenticated, calendarRouter);
